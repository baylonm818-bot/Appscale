            ...
            child: Column(
              children: [
                ...
                DetailRow(
                  ...
                  label: 'IP Group',
                  value: child.belongsToIpGroup ? 'Yes' : 'None',
                ),
                const SizedBox(height: AppSpacing.md),
                DetailRow(
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  '${child.guardian.relationship} · ${child.guardian.contactNo}',
          ...
          if (linkedMother != null)
            InkWell(
              ...
              onTap: () {
                Navigator.push(
                  context,
                  appPageRoute(MotherProfileScreen(mother: linkedMother)),
                );
              },
              child: Container(
                padding: const EdgeInsets.all(14),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 2),
                          Text(
                            linkedMother.fullName == child.guardian.fullName
                                ? 'Same as Guardian'
                                : 'Linked mother record',
            ...
            Container(
              ...
              child: Text(
                'Not currently monitored as a beneficiary',
                style: AppTextStyles.body.copyWith(
                  fontSize: 12,
