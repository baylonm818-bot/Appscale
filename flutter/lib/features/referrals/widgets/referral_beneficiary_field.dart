...
class ReferralBeneficiaryResult {
  ...
  const ReferralBeneficiaryResult({
    required this.id,
    required this.name,
...
class ReferralBeneficiaryField extends StatefulWidget {
  ...
  @override
  State<ReferralBeneficiaryField> createState() =>
      _ReferralBeneficiaryFieldState();
}
...
class _ReferralBeneficiaryFieldState extends State<ReferralBeneficiaryField> {
  ...
  void _onQueryChanged(String query) {
    final results = widget.type == 'child'
        ? ChildRepository()
              .search(query, barangay: widget.barangay)
              .map(
      ...
      children: [
        ...
        if (widget.selected != null && !_isSearching)
          ...
          if (_isSearching) ...[
            ...
            if (_results.isEmpty)
              Text(
                'No match found in ${widget.barangay}.',
