...
class AddCounselingVisitScreen extends StatefulWidget {
  ...
  @override
  State<AddCounselingVisitScreen> createState() =>
      _AddCounselingVisitScreenState();
}
...
class _AddCounselingVisitScreenState extends State<AddCounselingVisitScreen> {
  ...
  bool get _isFormValid =>
      !_present ||
      _observation != 'Signs of concern' ||
      _observationNoteController.text.trim().isNotEmpty;

  Future<void> _handleSave() async {
    if (!_isFormValid) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Please describe what was observed')),
      );
      return;
    }
  ...
  Future<void> _promptInactive() async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (_) => AlertDialog(
        ...
        content: Text(
          'Move ${widget.mother.fullName} to Inactive? Her record and visit history stay saved and searchable.',
        ),
        actions: [
          TextButton(
          ...
          FilledButton(
            ...
            child: const Text('Move to Inactive'),
          ),
        ],
      ),
    );
    if (confirmed == true) {
      ...
      if (mother != null) {
        await _motherRepo.update(
          mother.copyWith(
            isActive: false,
            inactiveReason: 'Stopped breastfeeding',
          ),
        );
      }
    }
                      ...
                      FormSectionCard(
                        ...
                        children: [
                              ...
                              Wrap(
                                ...
                                children: _kTopics.map((t) {
                                  ...
                                  return FilterChip(
                                    ...
                                    selectedColor: _kAccent.withValues(
                                      alpha: 0.14,
                                    ),
                            ...
                            children: [
                              ...
                              if (_hasConcern) ...[
                                ...
                                AppTextField(
                                  ...
                                  hint: 'e.g. mastitis, low milk supply',
                                  icon: Icons.medical_information_outlined,
                                  controller: _concernNoteController,
                                ),
                              ],
                            ],
                          ),
                          Column(
                            ...
                            children: [
                              Text(
                                'Your observation of her condition',
                                style: AppTextStyles.label,
                              ),
                              const SizedBox(height: 6),
                              Row(
                              ...
                              if (_observation == 'Signs of concern') ...[
                                ...
                                AppTextField(
                                  label: 'Note, required',
                                  hint: 'e.g. looks thin, pale, fatigued',
                                  icon: Icons.notes_outlined,
                                  controller: _observationNoteController,
                                ),
                              ],
                            ],
                          ),
